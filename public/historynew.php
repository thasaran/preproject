<?php
	...
	// ดึงข้อมูลจากตาราง
	$sql = "SELECT * FROM device ORDER BY id DESC LIMIT 20";
    ...
    <div class="container">
        ...
        <main>
            <div class="tophistory">
                ...
                <button class="number"><a href="history3.php">3</a></button>

                <button class="number"><a href="history4.php">4</a></button>
                
                <button class="point"><a href="">...</a></button>

                <button class="new"><a href="historynew.php" class="activeclick">NEW</a></button>
